...
public class SnowFlake {
    ...
    private final static long DATA_CENTER_BIT = 5L;//数据中心占用的位数

    /**
     * 每一部分的最大值
     */
    private final static long MAX_DATA_CENTER_NUM = ~(-1L << DATA_CENTER_BIT);
    private final static long MAX_MACHINE_NUM = ~(-1L << DATA_CENTER_BIT);
    private final static long MAX_SEQUENCE = ~(-1L << DATA_CENTER_BIT);
